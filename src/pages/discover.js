...
const DiscoverPage = ({ router }) => {
  ...
  const params = {
    ...
    orderBy: query.sort === 'newest' ? 'createdAt' : 'name', // TODO: use most-popular instead of name
    limit: 12,
  };
              ...
              >
                <Flex width={[1, 0.8, 0.6]} justifyContent="space-evenly" flexWrap="wrap" mb={4}>
                  <Flex width={[1, null, 0.5]} justifyContent="center" alignItems="center" mb={[3, null, 0]}>
                    ...
                    <select name="sort" id="sort" value={query.sort || 'most popular'} onChange={onChange}>
                ...
                {!loading && data && data.allCollectives && (
                  <Fragment>
